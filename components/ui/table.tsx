...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn(" bg-slate-700", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-slate-500 transition-colors data-[state=selected]:bg-neutral-100 dark:data-[state=selected]:bg-neutral-800",
      className,
    )}
    {...props}
  />
