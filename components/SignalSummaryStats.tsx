import {
  ...
  const SignalSummaryStats = ({ data }) => {
    ...
    const totalLoss = losingTrades.reduce((acc, trade) => acc + trade.result_ticks, 0);
      ...
      <div className="rounded-xl bg-slate-800/50 p-4">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-1">
          ...
          <div className="rounded-lg bg-slate-700/50 p-4">
            ...
            <p className="text-2xl font-bold text-white">{summary.totalMFE}</p>
          ...
          <div className="rounded-lg bg-slate-700/50 p-4">
            ...
            <p className="text-2xl font-bold text-white">{summary.totalLoss}</p>
            <p className="mt-1 text-sm text-gray-400">
