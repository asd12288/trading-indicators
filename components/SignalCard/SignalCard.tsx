...
const SignalCard: React.FC<SignalCardProps> = React.memo(
  ...
  (prevProps, nextProps) => {
    ...
    return (
      ...
      prevProps.signalPassed.take_profit_price ===
        nextProps.signalPassed.take_profit_price &&
      prevProps.signalPassed.stop_loss_price ===
        nextProps.signalPassed.stop_loss_price &&
