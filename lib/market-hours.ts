...
const marketSchedule: MarketSchedule = {
  ...
  "ES": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  "NQ": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  "RTY": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  "YM": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  "MYM": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  "M2K": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  "MES": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  "MNQ": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  ...
  // Forex Futures
  "6E": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  "6B": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  "6J": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  "6A": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  "M6E": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  
  // Commodities
  "CL": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  "GC": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  "SI": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  "NG": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  "HG": { open: 23, close: 22, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 22, breakEnd: 23 },
  
  // Agriculture
  "ZC": { open: 23, close: 19.75, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 19.75, breakEnd: 23 },
  "ZW": { open: 23, close: 19.75, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 19.75, breakEnd: 23 },
  "ZS": { open: 23, close: 19.75, dayStart: 0, dayEnd: 5, hasBreak: true, breakStart: 19.75, breakEnd: 23 },
...
export function isMarketOpen(instrumentName: string): boolean {
  ...
  if (marketHours.open > marketHours.close) {
    ...
    if (utcHour >= marketHours.open || utcHour < marketHours.close) {
      ...
      if (marketHours.hasBreak && 
          marketHours.breakStart !== undefined && 
          marketHours.breakEnd !== undefined) {
        if (utcHour >= marketHours.breakStart && utcHour < marketHours.breakEnd) {
...
function getMarketHours(symbol: string): MarketHours | null {
  ...
  if (symbol.includes('USD') || symbol.includes('EUR') || 
      symbol.includes('JPY') || symbol.includes('GBP')) {
...
export function getNextMarketOpen(instrumentName: string): Date | null {
  ...
  if (marketHours.open === 0 && marketHours.close === 24 && 
      marketHours.dayStart === 0 && marketHours.dayEnd === 6) {
...
function isInBreakPeriod(
  ...
  if (currentDay >= marketHours.dayStart && currentDay <= marketHours.dayEnd) {
    ...
    if (marketHours.breakStart > marketHours.breakEnd) {
      ...
      return currentHour >= marketHours.breakStart || currentHour < marketHours.breakEnd;
    } else {
