...
export async function POST(req: NextRequest) {
  try {
    ...
    const html = await renderAsync(SignalNotificationEmail({ signal, previewUrl, baseUrl }));
    ...
    console.log(`Email results: ${successful} successful, ${failed} failed, out of ${usersToNotify.length} total.`);
